...
impl From<ChoiceMessageSchema> for burn_lm_inference::Message {
...
impl From<ChoiceMessageRoleSchema> for burn_lm_inference::MessageRole {
    fn from(role: ChoiceMessageRoleSchema) -> Self {
        match role {
            ...
            ChoiceMessageRoleSchema::Unknown(value) => {
                burn_lm_inference::MessageRole::Unknown(value)
            }
        }
    }
}
